...
<div class="split-text">
  ...
  + Stuctural Verification
    + How does the descriptive and causal structure of the model reflect the empirical world?
      + 'Verisimilitude' in Jason Thompson's talk
  + Confirmability
...
<div class="split"><div class="split-text">
  ...
  + **Verifiability** &mdash; I don't remember unit testing... but it's been run hundreds of thousands of times
    + Level 1: _Model not expected to crash with any parameter setting or input_
